...
def train():
    ...
    print('name of cuda:', torch.cuda.get_device_name(0))
...
def test(test_T, test_U, allAcc, User_List, iter, filename=result_out_path+data_input.split('.dat')[0]+'.txt'):
    ...
    try:
        ...
        ftestw.write(" Accuracy1:" + str(float(acc) / step) + " ")
        ftestw.write(" Accuracy5:" + str(float(AccTop5) / step) + " ")
